...
const EditFullRentForm = ({ onSubmit, onCancel, isLoading, errors = {}, rentData }) => {
  ...
  useEffect(() => {
    if (rentData) {
      ...
      setFormData({
        id_rent_assigment: rentData.id_rent_assignemt || rentData.id_rent_assigment || '', // Handle both potential incoming keys
  ...
  return (
    <form onSubmit={handleSubmit} className="add-object-form">
      <div className="input-group">
        <label htmlFor="id_rent_assigment" className="input-label">Umowa Najmu</label>
          ...
          >
            ...
            {assignmentsLoading ? (
              <option value="" disabled>Ładowanie umów...</option>
                ...
                <option value="" disabled>Brak dostępnych umów</option>
            )}
          </select>
        </div>
