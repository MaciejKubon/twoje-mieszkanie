          ...
          <table className="data-table">
            ...
            <tbody>
              {objects.map((obj, index) => (
                ...
                >
                  <td style={{ fontWeight: 500, color: 'var(--text-main)' }}>{obj.name}</td>
                  <td>{getTypeLabel(obj.type_of_building)}</td>
                  <td>{obj.country}</td>
                  <td>{obj.city}</td>
                  <td>
                    {obj.street} {obj.house_number}{obj.apartment_number ? `/${obj.apartment_number}` : ''}
                  </td>
                </tr>
              ))}
            </tbody>
